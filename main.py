...
from utils.tools import generate_categories
...
def main(config):
    ...
    model, _ = category_xclip.load(config.MODEL.PRETRAINED, config.MODEL.ARCH, 
...
def train_one_epoch(epoch, model, category_pred_model, criterion, optimizer, lr_scheduler, train_loader, text_labels, category_labels, config, mixup_fn):
    ...
    for idx, batch_data in enumerate(train_loader):
        ...
        output = model(images, texts, categories, category_weights)
